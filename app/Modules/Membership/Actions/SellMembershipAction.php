...
class SellMembershipAction
{
    ...
    public function execute(
        ...
        $membership = DB::transaction(function () use (
            ...
            $membership->plan_price_snapshot = $price->price;
            $membership->plan_joining_fee_snapshot = $price->joiningFee;
            ...
            $membership->starts_on = $dates->startsOn->toDateString();
            $membership->expires_on = $dates->expiresOn->toDateString();
            $membership->grace_days = $dates->graceDays;
            $membership->grace_ends_on = $dates->graceEndsOn->toDateString();
