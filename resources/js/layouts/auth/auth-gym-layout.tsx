...
export default function AuthGymLayout({
    ...
    const { gymName, gymLogoUrl } = usePage().props as {
        gymName?: string | null;
        gymLogoUrl?: string | null;
    };
    const brandName = gymName || DEFAULT_BRAND;

    return (
        <div className="dark theme-scope relative grid min-h-svh overflow-hidden bg-gradient-to-br from-emerald-950 via-zinc-950 to-black text-foreground lg:grid-cols-2">
            ...
            <div className="relative z-10 hidden flex-col justify-between p-10 lg:flex">
                ...
                >
                    <span className="flex size-10 items-center justify-center overflow-hidden rounded-xl bg-white/10">
                        {gymLogoUrl ? (
                            <img
                                src={gymLogoUrl}
                                alt={brandName}
                ...
                <p className="text-xs text-white/40">
                    &copy; {new Date().getFullYear()} {DEFAULT_BRAND} &mdash;
                    built for gyms that never skip leg day.
                </p>
            </div>
            ...
            <div className="relative z-10 flex items-center justify-center p-6 sm:p-10">
                <div className="w-full max-w-xl space-y-6">
                    ...
                    >
                        <span className="flex size-9 items-center justify-center overflow-hidden rounded-xl bg-emerald-500/10">
                            {gymLogoUrl ? (
                                <img
                                    src={gymLogoUrl}
                                    alt={brandName}
