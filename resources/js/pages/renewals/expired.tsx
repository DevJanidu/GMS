...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Expired', href: MembershipExpiredController.index.url() },
];
...
export default function ExpiredMemberships({
    ...
    return (
        <>
            <Head title="Expired memberships" />

            <div className="flex flex-1 flex-col gap-6 p-4">
                <PageHeader
                    title="Expired memberships"
                    description="Memberships whose grace period has fully elapsed."
                />
                ...
                {branches.length > 1 && (
                    <Select
                        ...
                        onValueChange={(value) =>
                            router.get(
                                MembershipExpiredController.index.url(),
                                {
                                    branch_id:
                ...
                {memberships.data.length === 0 ? (
                    <EmptyState
                        ...
                        description="Memberships will show up here once their grace period fully elapses."
                    />
                ) : (
...
ExpiredMemberships.layout = { breadcrumbs };
